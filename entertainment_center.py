...
star_wars_episode_4 = media.Movie(
...
# Star Wars Episode V
star_wars_episode_5 = media.Movie(
...
star_wars_episode_6 = media.Movie(
...
# Star Wars Episode I
star_wars_episode_1 = media.Movie(
...
star_wars_episode_2 = media.Movie(
    "Star Wars: Episode II - Attack of the Clones",
    "https://upload.wikimedia.org/wikipedia/en/3/32/" +
    "Star_Wars_-_Episode_II_Attack_of_the_Clones_%28movie_poster%29.jpg",
    "https://www.youtube.com/watch?v=gYbW1F_c9eM"
    )

# Star Wars Episode III
star_wars_episode_3 = media.Movie(
...
# Create a list with the favorites movies
movies = [
    star_wars_episode_4,
    star_wars_episode_5,
    star_wars_episode_6,
...
# Generate HTML and open in the browser
